...
import SectionSocialMedia from "../../AboutUsPage/Sections/SectionsSocialMedia.js";
              ...
              <div className={classes.blogTags}>
                <Badge color="blue">
                  <a href="http://www.freepik.com">
                    Photography Designed by stories / Freepik
                  </a>
                </Badge>
              </div>
            </GridItem>
            ...
            <GridContainer>
              ...
              <GridItem xs={12} sm={8} md={8}>
                ...
                <p className={classes.description}>
                  My name is Pumela Msweli, I am your writing coach. You have
                  come to the right place for ideas, insights and tips to create
                  and write up your research projects.
                </p>
              </GridItem>
              <GridItem xs={12} sm={2} md={2}>
