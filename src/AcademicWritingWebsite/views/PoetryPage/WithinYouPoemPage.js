...
import SectionWithinYouPoem from "./Sections/SectionWithYouPoem.js";
...
export default function RoyalPoemPage({ ...rest }) {
  ...
  return (
    <div>
      ...
      />
      <Parallax
        image={require("assets/img/academicWritingImages/PoetryImages/msweliWithinYou.jpg")}
        filter="dark"
      >
