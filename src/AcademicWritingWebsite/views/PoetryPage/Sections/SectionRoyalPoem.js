...
import SectionTestimonials from "AcademicWritingWebsite/views/PoetryPage/Sections/SectionTestimonials.js";
...
the children that have been swallowed by 
poverty and corruption;
swallowed by dis-ease, 
swallowed by the discomforts
of living in this world that is filled with so many dragons;
the dragons who keep on sapping the blood and vitality of
...
Cleanse, purify, and dispel all forms of Darkness;
We have had enough of lies clothed in different
shapes and forms;
We have had enough of darkness
manifesting in our communities in the form
greed and corruption; in the form of illusions that are entrenched
by the need for things that create more darkness;
in the form of over consumption of things 
