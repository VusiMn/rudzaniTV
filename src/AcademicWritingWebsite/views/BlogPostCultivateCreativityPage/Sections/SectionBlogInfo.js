          ...
          <Card plain profile className={classes.card}>
            <GridContainer>
              ...
              <GridItem xs={12} sm={8} md={8}>
                ...
                My name is Pumela Msweli, I am your writing coach. You have come to the right place for ideas, insights and tips tocreate and write up your research projects. 
                </p>
              </GridItem>
              <GridItem xs={12} sm={2} md={2}>
