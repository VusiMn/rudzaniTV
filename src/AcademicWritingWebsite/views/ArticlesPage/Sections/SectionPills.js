    ...
    <div className={classes.section}>
      <GridContainer>
        ...
        <GridItem xs={12} sm={6} md={6}>
          ...
          >
            <CardBody background>
              <h6 className={classes.category}>Problems and Perspectives in Management"</h6>
        ...
        <GridItem xs={12} sm={12} md={12}>
          ...
          >
            <CardBody background>
              ...
              <a href='https://scholar.google.com/citations?user=YNeIukoAAAAJ&hl=en' target = "_blank">
                <h3 className={classes.cardTitle}>
                Prof. Pumela Msweli  
                </h3>
              </a>
              <p className={classes.category}>
              Visit Google Scholar for more published academic writing research 
              </p>
              <Button round href="#pablo" color="danger">
                <a href='https://scholar.google.com/citations?user=YNeIukoAAAAJ&hl=en' target = "_blank">
